...
\subsection{Statistical and Error Analysis}

\subsubsection{Statistical Significance}

McNemar's test confirms that the over-parameterized $\text{ScaledCNN}(k=64)$ outperforms the SVM baseline ($p \approx 0$, \autoref{tab:mcnemar_results}).
