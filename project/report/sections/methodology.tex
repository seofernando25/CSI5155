...
This configuration ensures sufficient time for models to fit the noisy training data, which isrequired for the "second descent" \cite{nakkiran2019deep}.
